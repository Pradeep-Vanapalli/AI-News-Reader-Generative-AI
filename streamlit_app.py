...
st.subheader('Built with ❤️ on Midjourney, OpenAI, D-ID and Streamlit')
...
if st.button("Generate"):
    if image_url.strip() and query.strip() and num_news is not None and num_news > 0:
        ...
        with col1:
            st.info("Your AI News Anchor: Katie")
        ...
        with col3:
            final_text = f"""
                Hello World, I'm Katie, your AI News Anchor. Bringing you the latest updates for {query}.
